...
/**
  ...
  *
  * @checksum - 14b3fe3d23b5043e3fa504cdd6ca176d64cca4f3fd855ebb54545be89a256d71
  * @variables - radius=rounded,accentColor=blue,colorTemperature=stone,spacing=1.5,scale=sm,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=500,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:border-stone-400": true,
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-stone-500": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-stone-500": true,
  ...
  "range__input": {
    ...
    "group/input": true,
    "cursor-pointer": true,
    "[&::-webkit-slider-runnable-track]:bg-stone-500/50": true,
    ...
    "[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-stone-400": true,
    ...
    "[&::-moz-range-track]:bg-stone-500/50": true,
  ...
  "submit__input": {
    ...
    "disabled:border-stone-500": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "group-data-[multiple]:border-stone-400": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-stone-500": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "data-[is-active=true]:ring-blue-300": true,
    "aria-selected:ring-blue-300": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=tab]/wrapper:border-stone-400": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:before:border-stone-400": true,
    ...
    "group-data-[tab-style=progress]/wrapper:after:bg-stone-400": true,
