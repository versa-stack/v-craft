...
* add BRANCH env var to semantic-release for correct branch detection ([7aca280](https://github.com/versa-stack/v-craft/commit/7aca280c00b46602eead4f90ab17dce7d1ccfac4))
...
* add ref to checkout for correct branch detection in semantic-release ([5e30d30](https://github.com/versa-stack/v-craft/commit/5e30d3004c6b9cc450332c346fa5f5dc9864eb3a))
...
* Added release commit. ([6fd773d](https://github.com/versa-stack/v-craft/commit/6fd773d37b6582bebf0003e507d0e521c902752a))
...
* deploy release ([c3bc899](https://github.com/versa-stack/v-craft/commit/c3bc899bc486967f5df1a22f85254b3892720258))
* deploy release ([c89ac34](https://github.com/versa-stack/v-craft/commit/c89ac34a88f735fa52fd0a616e893c8419e1cbb5))
...
* remove --no-ci flag and unnecessary git config for correct branch detection ([f026e4c](https://github.com/versa-stack/v-craft/commit/f026e4c38b16d8ea7c48232641e9d818f35bc64c))
...
* remove beta from release job - only run on merge targets ([8383d81](https://github.com/versa-stack/v-craft/commit/8383d81371574e8bd021942ac099f6d2a607626c))
...
* remove NPM registry configuration from test workflow ([a79dc69](https://github.com/versa-stack/v-craft/commit/a79dc69e15e872d69c1189d8965c08d012717313))
...
* restore beta to release job conditions ([b94bfa6](https://github.com/versa-stack/v-craft/commit/b94bfa6790ca8f95f4b3136e20d419d07503d518))
...
* restore version field to package.json ([d9b902c](https://github.com/versa-stack/v-craft/commit/d9b902cd5ae7e0ae26bd17cc6d1ff9c35e75baf0))
...
* update workflow for npm publishing on release branches ([797f4a5](https://github.com/versa-stack/v-craft/commit/797f4a5deb5540f77a58b4befa88c96a8a2304c3))
...
* use --branches flag to explicitly tell semantic-release to use beta branch ([148bf6d](https://github.com/versa-stack/v-craft/commit/148bf6db7fa2597295c99a34fce067aef5ab3180))
...
* verify beta release versioning ([3e2a03c](https://github.com/versa-stack/v-craft/commit/3e2a03cd0668fb93c9f167bab1d337b53f7d9022))
...
* 0.9.0-rc.1 ([#35](https://github.com/versa-stack/v-craft/issues/35)) ([765c4b8](https://github.com/versa-stack/v-craft/commit/765c4b84591eff8996b1af5cbd3b12789cea66ae))
